...
resource "azurerm_policy_virtual_machine_configuration_assignment" "lz" {
  for_each = {
    for extension in local.azure_windows_virtual_machine_policy : extension.resource_index => extension
  }
